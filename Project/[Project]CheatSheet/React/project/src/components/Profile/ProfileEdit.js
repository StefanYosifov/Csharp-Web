                                    ...
                                    <div className="col-span-6 sm:col-span-4">
                                        ...
                                        <div className="mt-1 rounded-md shadow-sm">
                                            <textarea
                                                ...
                                                value={formData.ProfileDescription == null ? formData.ProfileDescription = '' : formData.ProfileDescription}
                                                onChange={handleInputChange}
                                            ></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-span-6">
                                        ...
                                        <div className="mt-1 rounded-md shadow-sm">
                                            <input
                                                ...
                                                value={formData.ProfileBackground == null ? formData.ProfileBackground = '' : formData.ProfileBackground}
                                                onChange={handleInputChange}
                                            />
                                        </div>
                                    </div>
