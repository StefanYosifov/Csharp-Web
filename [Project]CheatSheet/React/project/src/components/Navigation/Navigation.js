...
function Navigation() {
  ...
  <ul className="flex justify-between items-center py-4 px-6 m-0">
    <li>
      <NavLink to="/home" className="text-ellipsis text-white px-2 py-1 rounded-lg hover:bg-red-700">
        Home
      </NavLink>
    </li>
    <li>
    ...
    <li>
      <NavLink to="/resource" className="text-white px-2 py-1 rounded-lg hover:bg-red-700">
        Resource
      </NavLink>
    </li>
    <li className="relative">
      <button className="text-white px-2 py-1 rounded-lg hover:bg-red-700 focus:outline-none" onClick={handleMenuClick}>
